...
const ServiceDetails = () => {
    return (
        <section className="service-details">
            ...
            {/* <!-- top section  --> */}
            <div className="container container--width top-section">
            ...
            {/* <!-- analysis section  --> */}
            <div className="container container--width analysis">
            ...
            {/* <!-- Benefits  --> */}
            <div class="container container--width benifits">
                <div class="row g-5">
            ...
            <div class="container container--width competitive-analysis">
