...
function NextArrow(props) {
    ...
    return (
      <div
        className={className}
        style={{ ...style, backgroundImage:`url(${process.env.PUBLIC_URL}/images/digital-icons/digital-testimonial-left.png)` }}
        onClick={onClick}
      />
    );
  }
  ...
  function PrevArrow(props) {
    ...
    return (
      <div
        className={className}
        style={{ ...style, backgroundImage:`url(${process.env.PUBLIC_URL}/images/digital-icons/digital-testimonial-right.png)` }}
        onClick={onClick}
      />
    );
  }
