          ...
          >
            <div className="left-section">
              <h1 className="title hover-line">
                TechAI Leverages A<br></br>Spectrum Of Cutting-Edge<br></br>
                Technologies
              </h1>
              <p className="desc hover-line">
                These agencies can be at the federal, state, or local level and
                handle a wide range<br></br>of issues, from healthcare and
                transportation to national security and environmental<br></br>
                protection.
              </p>
              ...
              <ul className="list-unstyled banner7-buttons">
                ...
                <li>
                  <Link className="case-btn"> View Case Study</Link>
                </li>
              </ul>
              {/* <!-- brands section --> */}
                ...
                <div className="col-12 col-sm-6">
                  <div className="thumb-top-left">
                    <ul className="list-unstyled d-flex flex-column">
                      ...
                      <li className="desc">
                        Cut the Code is a leading no-code agency & Webflow
                        Partner based
                      </li>
                    </ul>
                  </div>
