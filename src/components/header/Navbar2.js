                    ...
                    <div className="header-navbar">
                        ...
                        <nav className="mainmenu-nav" id="mobilemenu-popup">
                            ...
                            <li className="menu-item-has-children">
                                ...
                                <li><Link to="portfolio-2.html">Portfolio II Page</Link></li>
                                <li><Link to="service-detail.html">Services Details</Link></li>
                        ...
                        <ul className="nav-right-btn">
                            <li><Link to="register.html" className="btn-login">Login</Link></li>

                            <li>
                            <Link to="contact.html" className="business-btn btn-fill-primary mt-1"
                                >Join Now</Link>
                            </li>
                        </ul>
                        </div>
